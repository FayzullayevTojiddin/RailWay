        ...
        <div class="flex flex-wrap gap-3">
            <button 
                ...
                @class([
                    ...
                    'bg-blue-500 text-white shadow-md' => $this->activeType === 'yuk_ortilishi',
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-600' => $this->activeType !== 'yuk_ortilishi',
                ])
            >
                Oylik yuk ortilishi
            </button>
            ...
            <button 
                ...
                @class([
                    'px-5 py-2.5 rounded-lg font-medium transition-all duration-200',
                    'bg-yellow-500 text-white shadow-md' => $this->activeType === 'yuk_tushurilishi',
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-yellow-50 dark:hover:bg-gray-600' => $this->activeType !== 'yuk_tushurilishi',
                ])
            >
            ...
            <button 
                ...
                @class([
                    'px-5 py-2.5 rounded-lg font-medium transition-all duration-200',
                    'bg-green-500 text-white shadow-md' => $this->activeType === 'pul_tushumi',
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-gray-600' => $this->activeType !== 'pul_tushumi',
                ])
            >
                Oylik tushum
            </button>
            ...
            <button 
                ...
                @class([
                    'px-5 py-2.5 rounded-lg font-medium transition-all duration-200',
                    'bg-red-500 text-white shadow-md' => $this->activeType === 'xarajat_daromad',
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-gray-600' => $this->activeType !== 'xarajat_daromad',
                ])
            >
                Xarajat va daromad
            </button>
            ...
            <button 
                ...
                @class([
                    'px-5 py-2.5 rounded-lg font-medium transition-all duration-200',
                    'bg-purple-500 text-white shadow-md' => $this->activeType === 'boshqalar',
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-gray-600' => $this->activeType !== 'boshqalar',
                ])
            >
                Boshqa
            </button>
