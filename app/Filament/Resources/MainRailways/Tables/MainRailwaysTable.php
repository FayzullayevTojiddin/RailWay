...
namespace App\Filament\Resources\MainRailways\Tables;
...
class MainRailwaysTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Temir yo\'llar topilmadi')
            ->emptyStateDescription('Yangi temir yo\'l qo\'shish uchun yuqoridagi tugmani bosing')
